...
public class Board {
    ...
    public Set<Pair<Integer, Integer>> getPendingCells(){return this.pendingCells;}
    ...
    private List<Item> removePendingItems(){
        ...
        for(int i = 0; i < 10; i++){
            for(int j = 0; j < 10; j++){
                if(disposition[i][j] != null){
                    switch(i){
                        case 0: if(disposition[i+1][j] == null && disposition[i][j-1] == null && disposition[i][j+1] == null){
                                    return true;
                                }
                        case 9: if(disposition[i-1][j] == null && disposition[i][j-1] == null && disposition[i][j+1] == null) {
                                    return true;
                                }
                        default: switch(j){
                                    case 0: if(disposition[i+1][j] == null && disposition[i-1][j] == null && disposition[i][j+1] == null){
                                                return true;
                                            }
                                    case 9: if(disposition[i+1][j] == null && disposition[i-1][j] == null && disposition[i][j-1] == null) {
                                                return true;
                                            }
                                    default: if(disposition[i+1][j] == null && disposition[i-1][j] == null && disposition[i][j+1] == null && disposition[i][j-1] == null){
                                                return true;
                                             }
                                    }
        ...
        if (disposition[x][y] != null) {
            switch (x) {
                ...
                default: switch (y) {
                            ...
                            case 9:
                                return true;
                            default: if (disposition[x + 1][y] == null || disposition[x - 1][y] == null || disposition[x][y + 1] == null && disposition[x][y - 1] == null) {
                                        return true;
                                    }
                    }
            }
